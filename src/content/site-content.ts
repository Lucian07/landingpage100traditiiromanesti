...
export const siteContent = {
  ...
  despre: {
    ...
    paragrafe: [
      "Primul eveniment organizat de noi la Muzeul Național al Țăranului Român a fost în 2012, denumit „REAPAR prin DESIGN” (Remodelarea Artelor Populare și Artizanale Românești prin Design), un proiect cultural finanțat de Administrația Fondului Cultural Național (AFCN). Începând cu 2013, am organizat peste 10 târguri anual în curtea muzeului, depășind astăzi 150 de ediții ale târgului „100 de Tradiții Românești”, în acest loc plin de istorie de pe bulevardul Kiseleff nr. 3, cunoscut și ca „Muzeul de la Șosea”.",
